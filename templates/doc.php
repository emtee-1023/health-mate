...
<head>
  ...
  <style>
    ...
    /* Styling the SVG icon with success color */
  </style>
  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
      ...
      <div class="dropdown border-top">
        ...
        <ul class="dropdown-menu text-small shadow" color="success" aria-labelledby="dropdownUser3">
    ...
    <div class="bg-success text-white px-4 py-5 text-center" id="digital">
      <div class="py-5">
        <h1 class="display-5 fw-bold text-white">Welcome To Healthmate</h1>
        <div class="col-lg-6 mx-auto">
          <p class="fs-5 mb-4">Welcome to HealthMate Empowering Healthcare Professionals.
            At Health Mate, we provide a seamless digital platform for doctors to connect with patients, manage
            appointments, and deliver quality care remotely. Whether it's consulting patients, managing prescriptions,
            or accessing comprehensive medical histories, our platform simplifies
          </p>
          <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <button type="button" class="btn btn-outline-light btn-lg px-4">Dashboard</button>
          </div>
        </div>
      </div>
    </div>
