...
elseif(isset($_POST["add-medicine"])){
    ...
    $cat_insert = "INSERT INTO medicine(MedicineName, MedicinePhoto, UseCase, MedicinePrice) VALUES ('$tit', '$MedicinePhoto', '$content', '$price')";
...
elseif(isset($_POST["edit-medicine"])){
    ...
    $updqry = "UPDATE medicine SET MedicineName='$tit', UseCase='$content', MedicinePrice='$price' WHERE MedicineID  = '$id'";
