...
@media (max-width: 480px) {
    .signup-container {
        padding: 15px;
        max-width: 100%; /* Allows the container to use full width on small screens */
    }

    .btn {
        font-size: 14px; /* Slightly smaller button text for smaller screens */
    }
}
...
<body>
    ...
    <div class="signup-container">
        ...
        <form action="doctor-registration.php" method="post">
